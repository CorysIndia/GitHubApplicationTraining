...
{
    public class PbIndFbConf2L_01 : RSIControlModel
    {
        static PbIndFbConf2L_01()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PbIndFbConf2L_01), new FrameworkPropertyMetadata(typeof(PbIndFbConf2L_01)));
        }

		public PbIndFbConf2L_01()
        {
        ...
        public static readonly DependencyProperty ControlMarginProperty =
            DependencyProperty.Register("ControlMargin", typeof(Thickness), typeof(PbIndFbConf2L_01));
        ...
        public static readonly DependencyProperty FeedbackProperty =
            DependencyProperty.Register("Feedback", typeof(bool), typeof(PbIndFbConf2L_01));
...
Button lights up when Feedback is True, goes to grey when Feedback is False.")]
        ...
        public static readonly DependencyProperty PushedProperty =
            DependencyProperty.Register("Pushed", typeof(bool), typeof(PbIndFbConf2L_01));
        ...
        /// ZZCMD_UO Property
        /// </summary>
        public static readonly DependencyProperty ZZCMD_UOProperty =
            DependencyProperty.Register("ZZCMD_UO", typeof(string), typeof(PbIndFbConf2L_01));

        /// <summary>
        /// Gets or sets the ZZCMD_UO.  
        /// </summary>
		[Category("RSI")]
        [Description(@"")]
        public string ZZCMD_UO
        {
            get { return (string)this.GetValue(ZZCMD_UOProperty); }
            set { this.SetValue(ZZCMD_UOProperty, value); }
        }

        /// ZZFBK_UO Property
        /// </summary>
        public static readonly DependencyProperty ZZFBK_UOProperty =
            DependencyProperty.Register("ZZFBK_UO", typeof(string), typeof(PbIndFbConf2L_01));

        /// <summary>
        /// Gets or sets the ZZFBK_UO.  
        /// </summary>
		[Category("RSI")]
        [Description(@"")]
        public string ZZFBK_UO
        {
            get { return (string)this.GetValue(ZZFBK_UOProperty); }
            set { this.SetValue(ZZFBK_UOProperty, value); }
        }
        ///////////////////////////////////////////vAIBHAV////////////////////////////
        ...
        public static readonly DependencyProperty NameStoreProperty =
            DependencyProperty.Register("NameStore", typeof(string), typeof(PbIndFbConf2L_01));
        ...
        public static readonly DependencyProperty ColourProperty =
            DependencyProperty.Register("Colour", typeof(int), typeof(PbIndFbConf2L_01));
...
8 - Gray")]
        ...
        public static readonly DependencyProperty WinNameProperty =
            DependencyProperty.Register("WinName", typeof(string), typeof(PbIndFbConf2L_01));
        ...
        public static readonly DependencyProperty ConfirmationMessageProperty =
            DependencyProperty.Register("ConfirmationMessage", typeof(string), typeof(PbIndFbConf2L_01));
...
")]
        ...
        public static readonly DependencyProperty DisableProperty =
            DependencyProperty.Register("Disable", typeof(bool), typeof(PbIndFbConf2L_01));
...
False: enable button")]
        ...
        public static readonly DependencyProperty fTagNameProperty =
            DependencyProperty.Register("fTagName", typeof(string), typeof(PbIndFbConf2L_01));
        ...
        public static readonly DependencyProperty gTagNameProperty =
            DependencyProperty.Register("gTagName", typeof(string), typeof(PbIndFbConf2L_01));
...
if (!string.IsNullOrWhiteSpace(this.gTagName)) yield return new Param("$gTagName", this.gTagName);
                if (!string.IsNullOrWhiteSpace(this.ZZCMD_UO)) yield return new Param("$ZZCMD_UO", this.ZZCMD_UO);
                if (!string.IsNullOrWhiteSpace(this.ZZFBK_UO)) yield return new Param("$ZZFBK_UO", this.ZZFBK_UO);
