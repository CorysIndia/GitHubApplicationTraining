...
{
    public class RE_START_Seq : RSIControlModel
    {
        static RE_START_Seq()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(RE_START_Seq), new FrameworkPropertyMetadata(typeof(RE_START_Seq)));
        }
        ...
        public static readonly DependencyProperty ControlMarginProperty =
            DependencyProperty.Register("ControlMargin", typeof(Thickness), typeof(RE_START_Seq));
        ...
        public static readonly DependencyProperty CMPProperty =
            DependencyProperty.Register("CMP", typeof(string), typeof(RE_START_Seq));
        ...
        public static readonly DependencyProperty BLKProperty =
            DependencyProperty.Register("BLK", typeof(string), typeof(RE_START_Seq));
        ...
        public static readonly DependencyProperty PARProperty =
            DependencyProperty.Register("PAR", typeof(string), typeof(RE_START_Seq));
        ...
        public static readonly DependencyProperty CONNProperty =
            DependencyProperty.Register("CONN", typeof(bool), typeof(RE_START_Seq));
        ...
        public static readonly DependencyProperty DISABLEProperty =
            DependencyProperty.Register("DISABLE", typeof(bool), typeof(RE_START_Seq));
        ...
        public static readonly DependencyProperty DISABLE_CONNProperty =
            DependencyProperty.Register("DISABLE_CONN", typeof(string), typeof(RE_START_Seq));
        ...
        public static readonly DependencyProperty ALARMProperty =
            DependencyProperty.Register("ALARM", typeof(bool), typeof(RE_START_Seq));
        ...
        public static readonly DependencyProperty ALARM_CONNProperty =
            DependencyProperty.Register("ALARM_CONN", typeof(string), typeof(RE_START_Seq));
        ...
        public static readonly DependencyProperty MSGProperty =
            DependencyProperty.Register("MSG", typeof(string), typeof(RE_START_Seq));
