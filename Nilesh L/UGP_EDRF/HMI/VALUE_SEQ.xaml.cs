...
namespace UGP_EDRF.HMI
{
    public class VALUE_SEQ : RSIControlModel
    {
        ...
        /// ZV_OP Property
        /// </summary>
        public static readonly DependencyProperty ZV_OPProperty =
            DependencyProperty.Register("ZV_OP", typeof(bool), typeof(VALUE_SEQ));

        /// <summary>
        /// Gets or sets the ZV_OP.  
        /// </summary>
		[Category("RSI")]
        [Description(@"")]
        public bool ZV_OP
        {
            get { return (bool)this.GetValue(ZV_OPProperty); }
            set { this.SetValue(ZV_OPProperty, value); }
        }
        ...
        /// ZV_CL Property
        /// </summary>
        public static readonly DependencyProperty ZV_CLProperty =
            DependencyProperty.Register("ZV_CL", typeof(bool), typeof(VALUE_SEQ));

        /// <summary>
        /// Gets or sets the ZV_CL.  
        /// </summary>
		[Category("RSI")]
        [Description(@"")]
        public bool ZV_CL
        {
            get { return (bool)this.GetValue(ZV_CLProperty); }
            set { this.SetValue(ZV_CLProperty, value); }
        }
        ...
        /// ZV_CL01 Property
        /// </summary>
        public static readonly DependencyProperty ZV_CL01Property =
            DependencyProperty.Register("ZV_CL01", typeof(bool), typeof(VALUE_SEQ));

        /// <summary>
        /// Gets or sets the ZV_CL01.  
        /// </summary>
		[Category("RSI")]
        [Description(@"")]
        public bool ZV_CL01
        {
            get { return (bool)this.GetValue(ZV_CL01Property); }
            set { this.SetValue(ZV_CL01Property, value); }
        }
