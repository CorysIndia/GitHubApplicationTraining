...
For example: gTBNSTART_HMI.name")]
        ...
        public static readonly DependencyProperty ZDescription01Property =
            DependencyProperty.Register("ZDescription01", typeof(string), typeof(PbMomFbConf_01_M));
        ...
        /// <summary>
        /// ZDescription02 Property
        /// </summary>
        public static readonly DependencyProperty ZDescription02Property =
            DependencyProperty.Register("ZDescription02", typeof(string), typeof(PbMomFbConf_01_M));

        /// <summary>
        /// Gets or sets the ZDescription02.  
        /// </summary>
		[Category("RSI")]
        [Description(@"The temporary variable to store the Intouch window name.")]
        public string ZDescription02
        {
            get { return (string)this.GetValue(ZDescription02Property); }
            set { this.SetValue(ZDescription02Property, value); }
        }
...
if (!string.IsNullOrWhiteSpace(this.NameStore)) yield return new Param("$NameStore", this.NameStore);
                ...
                if (!string.IsNullOrWhiteSpace(this.ZDescription02)) yield return new Param("$ZDescription02", this.ZDescription02);
