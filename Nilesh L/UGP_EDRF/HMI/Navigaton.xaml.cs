...
{
    public class Navigaton : RSIControlModel
    {
        static Navigaton()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(Navigaton), new FrameworkPropertyMetadata(typeof(Navigaton)));
        }
        ...
        public static readonly DependencyProperty ControlMarginProperty =
            DependencyProperty.Register("ControlMargin", typeof(Thickness), typeof(Navigaton));
        ...
        public static readonly DependencyProperty DISPProperty =
            DependencyProperty.Register("DISP", typeof(string), typeof(Navigaton));
        ...
        public static readonly DependencyProperty _CONN1Property =
            DependencyProperty.Register("_CONN1", typeof(bool), typeof(Navigaton));
        ...
        public static readonly DependencyProperty PRTProperty =
            DependencyProperty.Register("PRT", typeof(string), typeof(Navigaton));
        ...
        public static readonly DependencyProperty TypeProperty =
            DependencyProperty.Register("Type", typeof(string), typeof(Navigaton));
