...
{
    public class TOP_BANNER_M39_K_0003A : RSIControlModel
    {
        static TOP_BANNER_M39_K_0003A()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(TOP_BANNER_M39_K_0003A), new FrameworkPropertyMetadata(typeof(TOP_BANNER_M39_K_0003A)));
        }

		
         public static readonly DependencyProperty QuickLinkTab_N2_III1_NameStoreProperty = DependencyProperty.Register(QuickLinkTab_N2_III1_NameStorePropertyName, typeof(string), typeof(TOP_BANNER_M39_K_0003A)); 
         ...
         public static readonly DependencyProperty QuickLinkTab_N2_III1_SelectedProperty = DependencyProperty.Register(QuickLinkTab_N2_III1_SelectedPropertyName, typeof(string), typeof(TOP_BANNER_M39_K_0003A)); 
         ...
         public static readonly DependencyProperty QuickLinkTab_N2_III1_TabNameProperty = DependencyProperty.Register(QuickLinkTab_N2_III1_TabNamePropertyName, typeof(string), typeof(TOP_BANNER_M39_K_0003A)); 
         ...
         public static readonly DependencyProperty QuickLinkTab_N2_III1_TabVisibleProperty = DependencyProperty.Register(QuickLinkTab_N2_III1_TabVisiblePropertyName, typeof(string), typeof(TOP_BANNER_M39_K_0003A)); 
         ...
         public static readonly DependencyProperty QuickLinkTab_N2_III1_AlarmProperty = DependencyProperty.Register(QuickLinkTab_N2_III1_AlarmPropertyName, typeof(string), typeof(TOP_BANNER_M39_K_0003A)); 
