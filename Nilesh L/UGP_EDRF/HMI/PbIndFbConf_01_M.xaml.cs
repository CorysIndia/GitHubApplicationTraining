...
False: enable button")]
        ...
        /// ZCMD_UO Property
        /// </summary>
        public static readonly DependencyProperty ZCMD_UOProperty =
            DependencyProperty.Register("ZCMD_UO", typeof(string), typeof(PbIndFbConf_01_M));

        /// <summary>
        /// Gets or sets the ZCMD_UO.  
        /// </summary>
		[Category("RSI")]
        [Description(@"")]
        public string ZCMD_UO
        {
            get { return (string)this.GetValue(ZCMD_UOProperty); }
            set { this.SetValue(ZCMD_UOProperty, value); }
        }

        /// ZFBK_UO Property
        /// </summary>
        public static readonly DependencyProperty ZFBK_UOProperty =
            DependencyProperty.Register("ZFBK_UO", typeof(string), typeof(PbIndFbConf_01_M));

        /// <summary>
        /// Gets or sets the ZFBK_UO.  
        /// </summary>
		[Category("RSI")]
        [Description(@"")]
        public string ZFBK_UO
        {
            get { return (string)this.GetValue(ZFBK_UOProperty); }
            set { this.SetValue(ZFBK_UOProperty, value); }
        }
        ///////////////////////////////////////////vAIBHAV////////////////////////////
...
if (!string.IsNullOrWhiteSpace(this.gTagName)) yield return new Param("$gTagName", this.gTagName);
                if (!string.IsNullOrWhiteSpace(this.ZCMD_UO)) yield return new Param("$ZCMD_UO", this.ZCMD_UO);
                if (!string.IsNullOrWhiteSpace(this.ZFBK_UO)) yield return new Param("$ZFBK_UO", this.ZFBK_UO);
            }
        }
