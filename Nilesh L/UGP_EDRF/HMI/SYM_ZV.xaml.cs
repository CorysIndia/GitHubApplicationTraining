...
namespace UGP_EDRF.HMI
{
    public class SYM_ZV : RSIControlModel
    {
        ...
        /// <summary>
        /// ZV_RESET_BLK Property
        /// </summary>
        public static readonly DependencyProperty ZV_RESET_BLKProperty =
            DependencyProperty.Register("ZV_RESET_BLK", typeof(string), typeof(SYM_ZV));

        /// <summary>
        /// Gets or sets the ZV_RESET_BLK.  
        /// </summary>
		[Category("RSI")]
        [Description(@"")]
        public string ZV_RESET_BLK
        {
            get { return (string)this.GetValue(ZV_RESET_BLKProperty); }
            set { this.SetValue(ZV_RESET_BLKProperty, value); }
        }



        /// <summary>
        /// ZV_CLOSE_BLK Property
        /// </summary>
        public static readonly DependencyProperty ZV_CLOSE_BLKProperty =
            DependencyProperty.Register("ZV_CLOSE_BLK", typeof(string), typeof(SYM_ZV));

        /// <summary>
        /// Gets or sets the ZV_CLOSE_BLK.  
        /// </summary>
		[Category("RSI")]
        [Description(@"")]
        public string ZV_CLOSE_BLK
        {
            get { return (string)this.GetValue(ZV_CLOSE_BLKProperty); }
            set { this.SetValue(ZV_CLOSE_BLKProperty, value); }
        }
...
if (!string.IsNullOrWhiteSpace(this.ZV_RESET_BLK)) yield return new Param("$ZV_RESET_BLK", this.ZV_RESET_BLK);
if (!string.IsNullOrWhiteSpace(this.ZV_CLOSE_BLK)) yield return new Param("$ZV_CLOSE_BLK", this.ZV_CLOSE_BLK);
