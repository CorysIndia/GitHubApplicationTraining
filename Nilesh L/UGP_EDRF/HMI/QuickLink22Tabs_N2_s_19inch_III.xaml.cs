...
if (!string.IsNullOrWhiteSpace(this.aaReadme)) yield return new Param("$aaReadme", this.aaReadme);
                ...
                if (!string.IsNullOrWhiteSpace(this.Button11_NameStore)) yield return new Param("$Button11_NameStore", this.Button11_NameStore);
                if (!string.IsNullOrWhiteSpace(this.Button12_NameStore)) yield return new Param("$Button12_NameStore", this.Button12_NameStore);
                if (!string.IsNullOrWhiteSpace(this.Button13_NameStore)) yield return new Param("$Button13_NameStore", this.Button13_NameStore);
                if (!string.IsNullOrWhiteSpace(this.Button14_NameStore)) yield return new Param("$Button14_NameStore", this.Button14_NameStore);
                if (!string.IsNullOrWhiteSpace(this.Button15_NameStore)) yield return new Param("$Button15_NameStore", this.Button15_NameStore);
