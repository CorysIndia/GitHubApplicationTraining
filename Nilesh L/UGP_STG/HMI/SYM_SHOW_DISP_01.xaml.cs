...
namespace UGP_STG.HMI
{
    public class SYM_SHOW_DISP_01 : RSIControlModel
    {
        ...
        public Thickness ControlMargin
        {
         ...
         public static readonly DependencyProperty PRTProperty = DependencyProperty.Register(PRTPropertyName, typeof(string), typeof(SYM_SHOW_DISP_01)); 
         ...
         public static readonly DependencyProperty DISPProperty = DependencyProperty.Register(DISPPropertyName, typeof(string), typeof(SYM_SHOW_DISP_01)); 
