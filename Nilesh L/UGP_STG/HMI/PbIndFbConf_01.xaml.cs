...
{
    public class PbIndFbConf_01 : RSIControlModel
    {
        static PbIndFbConf_01()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PbIndFbConf_01), new FrameworkPropertyMetadata(typeof(PbIndFbConf_01)));
        }

		public PbIndFbConf_01()
        {
        ...
        public static readonly DependencyProperty ControlMarginProperty =
            DependencyProperty.Register("ControlMargin", typeof(Thickness), typeof(PbIndFbConf_01));
        ...
        public static readonly DependencyProperty FeedbackProperty =
            DependencyProperty.Register("Feedback", typeof(bool), typeof(PbIndFbConf_01));
...
Button lights up when Feedback is True, goes to grey when Feedback is False.")]
        ...
        public static readonly DependencyProperty PushedProperty =
            DependencyProperty.Register("Pushed", typeof(bool), typeof(PbIndFbConf_01));
        ...
        public static readonly DependencyProperty NameStoreProperty =
            DependencyProperty.Register("NameStore", typeof(string), typeof(PbIndFbConf_01));
        ...
        public static readonly DependencyProperty ColourProperty =
            DependencyProperty.Register("Colour", typeof(int), typeof(PbIndFbConf_01));
...
8 - Gray")]
        ...
        public static readonly DependencyProperty WinNameProperty =
            DependencyProperty.Register("WinName", typeof(string), typeof(PbIndFbConf_01));
        ...
        public static readonly DependencyProperty ConfirmationMessageProperty =
            DependencyProperty.Register("ConfirmationMessage", typeof(string), typeof(PbIndFbConf_01));
...
")]
        ...
        public static readonly DependencyProperty DisableProperty =
            DependencyProperty.Register("Disable", typeof(bool), typeof(PbIndFbConf_01));
...
False: enable button")]
        ...
        public static readonly DependencyProperty fTagNameProperty =
            DependencyProperty.Register("fTagName", typeof(string), typeof(PbIndFbConf_01));
        ...
        public static readonly DependencyProperty gTagNameProperty =
            DependencyProperty.Register("gTagName", typeof(string), typeof(PbIndFbConf_01));
