...
{
    public class SYM_FP_RAMP_01 : RSIControlModel
    {
        static SYM_FP_RAMP_01()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(SYM_FP_RAMP_01), new FrameworkPropertyMetadata(typeof(SYM_FP_RAMP_01)));
        }

		public SYM_FP_RAMP_01()
        {
        ...
        public static readonly DependencyProperty ControlMarginProperty =
            DependencyProperty.Register("ControlMargin", typeof(Thickness), typeof(SYM_FP_RAMP_01));
        ...
        public static readonly DependencyProperty PVProperty =
            DependencyProperty.Register("PV", typeof(double), typeof(SYM_FP_RAMP_01));
        ...
        public static readonly DependencyProperty PV_MinProperty =
            DependencyProperty.Register("PV_Min", typeof(double), typeof(SYM_FP_RAMP_01));
        ...
        public static readonly DependencyProperty PV_MaxProperty =
            DependencyProperty.Register("PV_Max", typeof(double), typeof(SYM_FP_RAMP_01));
        ...
        public static readonly DependencyProperty optionProperty =
            DependencyProperty.Register("option", typeof(string), typeof(SYM_FP_RAMP_01));
