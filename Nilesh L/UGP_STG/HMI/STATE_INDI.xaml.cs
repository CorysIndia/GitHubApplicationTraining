...
{
    public class STATE_INDI : RSIControlModel
    {
        static STATE_INDI()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(STATE_INDI), new FrameworkPropertyMetadata(typeof(STATE_INDI)));
        }
        ...
        public static readonly DependencyProperty ControlMarginProperty =
            DependencyProperty.Register("ControlMargin", typeof(Thickness), typeof(STATE_INDI));
        ...
        public static readonly DependencyProperty BLKProperty =
            DependencyProperty.Register("BLK", typeof(string), typeof(STATE_INDI));
        ...
        public static readonly DependencyProperty CMPProperty =
            DependencyProperty.Register("CMP", typeof(string), typeof(STATE_INDI));
        ...
        public static readonly DependencyProperty _CINProperty =
            DependencyProperty.Register("_CIN", typeof(bool), typeof(STATE_INDI));
