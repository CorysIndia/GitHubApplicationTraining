...
{
    public class QuickLinkTab_N1_short : RSIControlModel
    {
        static QuickLinkTab_N1_short()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(QuickLinkTab_N1_short), new FrameworkPropertyMetadata(typeof(QuickLinkTab_N1_short)));
        }

		public QuickLinkTab_N1_short()
        {
        ...
        public static readonly DependencyProperty ControlMarginProperty =
            DependencyProperty.Register("ControlMargin", typeof(Thickness), typeof(QuickLinkTab_N1_short));
        ...
        public static readonly DependencyProperty SelectedProperty =
            DependencyProperty.Register("Selected", typeof(bool), typeof(QuickLinkTab_N1_short));
        ...
        public static readonly DependencyProperty TabNameProperty =
            DependencyProperty.Register("TabName", typeof(string), typeof(QuickLinkTab_N1_short));
        ...
        public static readonly DependencyProperty TabVisibleProperty =
            DependencyProperty.Register("TabVisible", typeof(bool), typeof(QuickLinkTab_N1_short));
        ...
        public static readonly DependencyProperty NameStoreProperty =
            DependencyProperty.Register("NameStore", typeof(string), typeof(QuickLinkTab_N1_short));
        ...
        public static readonly DependencyProperty AlarmProperty =
            DependencyProperty.Register("Alarm", typeof(bool), typeof(QuickLinkTab_N1_short));
