...
{
    public class SYM_NORMAL : RSIControlModel
    {
        static SYM_NORMAL()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(SYM_NORMAL), new FrameworkPropertyMetadata(typeof(SYM_NORMAL)));
        }
        ...
        public static readonly DependencyProperty ControlMarginProperty =
            DependencyProperty.Register("ControlMargin", typeof(Thickness), typeof(SYM_NORMAL));
        ...
        public static readonly DependencyProperty PICK2Property =
            DependencyProperty.Register("PICK2", typeof(string), typeof(SYM_NORMAL));
        ...
        public static readonly DependencyProperty PRTProperty =
            DependencyProperty.Register("PRT", typeof(string), typeof(SYM_NORMAL));
        ...
        public static readonly DependencyProperty BPProperty =
            DependencyProperty.Register("BP", typeof(bool), typeof(SYM_NORMAL));
        ...
        public static readonly DependencyProperty FBProperty =
            DependencyProperty.Register("FB", typeof(bool), typeof(SYM_NORMAL));
        ...
        public static readonly DependencyProperty PICK1Property =
            DependencyProperty.Register("PICK1", typeof(string), typeof(SYM_NORMAL));
