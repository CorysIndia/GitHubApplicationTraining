...
{
    public class QuickLinkButton_MainMenu_III : RSIControlModel
    {
        static QuickLinkButton_MainMenu_III()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(QuickLinkButton_MainMenu_III), new FrameworkPropertyMetadata(typeof(QuickLinkButton_MainMenu_III)));
        }

		public QuickLinkButton_MainMenu_III()
        {
        ...
        public static readonly DependencyProperty ControlMarginProperty =
            DependencyProperty.Register("ControlMargin", typeof(Thickness), typeof(QuickLinkButton_MainMenu_III));
        ...
        public static readonly DependencyProperty PushedProperty =
            DependencyProperty.Register("Pushed", typeof(bool), typeof(QuickLinkButton_MainMenu_III));
        ...
        public static readonly DependencyProperty NameStoreProperty =
            DependencyProperty.Register("NameStore", typeof(string), typeof(QuickLinkButton_MainMenu_III));
