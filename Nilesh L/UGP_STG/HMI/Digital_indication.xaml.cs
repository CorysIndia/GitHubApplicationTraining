...
{
    public class Digital_indication : RSIControlModel
    {
        static Digital_indication()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(Digital_indication), new FrameworkPropertyMetadata(typeof(Digital_indication)));
        }

		public Digital_indication()
        {
        ...
        public static readonly DependencyProperty ControlMarginProperty =
            DependencyProperty.Register("ControlMargin", typeof(Thickness), typeof(Digital_indication));
        ...
        public static readonly DependencyProperty BLKProperty =
            DependencyProperty.Register("BLK", typeof(string), typeof(Digital_indication));
        ...
        public static readonly DependencyProperty CMPProperty =
            DependencyProperty.Register("CMP", typeof(string), typeof(Digital_indication));
        ...
        public static readonly DependencyProperty _CINProperty =
            DependencyProperty.Register("_CIN", typeof(bool), typeof(Digital_indication));
