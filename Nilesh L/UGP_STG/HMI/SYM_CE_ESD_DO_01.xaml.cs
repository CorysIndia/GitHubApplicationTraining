...
namespace UGP_STG.HMI
{
    public class SYM_CE_ESD_DO_01 : RSIControlModel
    {
        ...
        public static readonly DependencyProperty RESETProperty = DependencyProperty.Register(RESETPropertyName, typeof(string), typeof(SYM_CE_ESD_DO_01));
        public const string RESETPropertyName = "RESET";
        public string RESET
        {
